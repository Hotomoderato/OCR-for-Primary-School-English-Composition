...
h_conv1 = tf.nn.relu(
    tf.nn.conv2d(inputs, W_conv1, strides=[1, 1, 1, 1], padding='SAME') + b_conv1)
h_pool1 = tf.nn.max_pool(h_conv1, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='VALID')

conv1 = tf.nn.conv2d(inputs, W_conv1, strides=[1, 1, 1, 1], padding='SAME')
print('inputs', inputs.get_shape())
print("conv1_output", conv1.get_shape())
...
conv2 = tf.nn.conv2d(tf.nn.dropout(h_pool1, keep_prob), W_conv2, strides=[1, 1, 1, 1], padding='SAME')
print('conv2_input', tf.nn.dropout(h_pool1, keep_prob).get_shape())
print("conv2_output", conv2.get_shape())
...
conv3 = tf.nn.conv2d(tf.nn.dropout(h_pool2, keep_prob), W_conv3, strides=[1, 1, 1, 1], padding='SAME')
print('conv3_input', tf.nn.dropout(h_pool2, keep_prob).get_shape())
print("conv3_output", conv3.get_shape())
...
conv4 = tf.nn.conv2d(tf.nn.dropout(h_pool3, keep_prob), W_conv4, strides=[1, 1, 1, 1], padding='SAME')
print('conv4_input', tf.nn.dropout(h_pool3, keep_prob).get_shape())
print("conv4_output", conv4.get_shape())
